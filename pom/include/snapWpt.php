...
function snapWayPoints($type, $gpxfile){
    ...
    for ($i = 0; $i <= $size - 1; $i++) {
        ...
        $stringRequest = 'https://maps.googleapis.com/maps/api/directions/json?origin=' . $lat1 . ',' . $lon1 . '&destination=' . $lat1 . ',' . $lon1 . '&mode='.$mode.'&key=AIzaSyAexDog4mT1k1S63Py4r7AYTMd2cEf9W7o';
