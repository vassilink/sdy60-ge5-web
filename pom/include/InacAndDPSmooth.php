...
//που έχουν HDOP > $max_hdop και SAT < 4 (αν υπάρχουν)
function discardFaultPointsOfGpxFile($gpxfile, $max_hdop){
    ...
    define("MAX_HDOP",$max_hdop/*47*/);//Το μεγαλύτερο HDOP που ανεχόμαστε
